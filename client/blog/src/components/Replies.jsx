...
const Replies = ({commentId, postId, parentCommentId}) => {
    ...
    useEffect(()=>{
        const fetchData = async ()=>{
          ...
          ? await axios.get(`/replies/?commentId=${commentId}`)
          : await axios.get(`/replies/?parentCommentId=${parentCommentId}`);
    ...
    const handleAddReply = async () => {
        try {
          ...
          const response = await axios.post("/replies", cmt);
    ...
    const handleDeleteReply = async (replyId) => {
      try {
        await axios.delete(`/replies/${replyId}`); // Assuming your API route is "/comments/{commentId}" for deleting a comment
